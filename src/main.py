...
def main():
    ...
    #test
    try:
        # model = YOLO('yolov8n.pt') # 事前学習済みモデル
        # ファインチューニングしたモデルの重みファイルのパスを指定します
        # 例: 'runs/train/exp/weights/best.pt' や Colabで保存したパスなど
        fine_tuned_model_path = "models/weights/best.pt" # ★★★ ここにファインチューニングしたモデルの.ptファイルのパスを記述 ★★★
