...
if __name__ == '__main__':
    # --- 設定 ---
    dataset_base_dir = Path("C:/Users/akama/AppData/Local/Programs/Python/Python310/python_file/projects/tennisvision/data/processed/datasets/final_merged_dataset") # データセットのベースパス
